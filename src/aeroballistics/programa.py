...
repositório; ele está no relatório (DTIC AD0915628).
    ...
    b.calcular(aeroballistics.M437)             # as colunas desse bloco para um projétil
...
class Bloco:
    ...
    def funcao(self):
        """A função que implementa o bloco nesta adaptação."""
...
SPIN73 = ProgramaOriginal((
    Bloco(
        ...
        regras=("no cartão original, campos em branco valem DM = 0, BD = 1,00 e TEMP = 0 °F; "
                ...
                "em branco)",),
        implementacao="aeroballistics.nucleo.densidade_ar"),
    Bloco(
        ...
        implementacao="aeroballistics.nucleo.cx"),
    Bloco(
        ...
        implementacao="aeroballistics.nucleo.normal_e_momento"),
    Bloco(
        ...
        implementacao="aeroballistics.nucleo.cx2"),
    Bloco(
        ...
        lacunas=("o primeiro cartão do XE5 (Mach 0,01 a 1,75) não foi impresso: valores "
                 "recuperados pelas tabelas de saída",),
        implementacao="aeroballistics.nucleo.magnus"),
    Bloco(
        ...
        implementacao="aeroballistics.nucleo.coef_polinomio_magnus"),
    Bloco(
        ...
        implementacao="aeroballistics.nucleo.cmq"),
    Bloco(
        ...
        regras=("o divisor é uma constante do programa que o texto dá como 5,51, o "
                "comprimento do M437",),
        implementacao="aeroballistics.nucleo.clp"),
    Bloco(
        ...
        implementacao="aeroballistics.nucleo.estabilidade"),
    Bloco(
        ...
        implementacao="aeroballistics.nucleo.formatar"),
))
