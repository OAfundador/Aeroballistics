...
Uso (coordenadas SEMPRE na página já girada):
  ...
  python ferramentas/recorte.py 80 --visao --saida recortes/p80_visao.png

  # recorte por frações da página (x0 y0 x1 y1), com zoom
  python ferramentas/recorte.py 80 --caixa 0.34 0.34 0.86 0.40 --zoom 1.2 --saida recortes/p80_xc6.png

  # recorte em pixels (valores > 1 são tratados como pixels)
  python ferramentas/recorte.py 65 --caixa 1350 850 3329 1130 --saida recortes/p65_cab.png

  # índice JP2 direto, sem conversão de página
  python ferramentas/recorte.py --jp2 83 --visao --saida recortes/jp2_0083.png
