...
O 175 mm M437 (p. 65) está em `../m437_tabela.csv`. Aqui fica o 5"/38 NAVY (p. 53),
...
o CNA impresso (`../reconstrucao_B/dados_cna.py`). Onde a identidade fecha nas duas
...
CMA_538 = np.array([3.474, 3.514, 3.690, 3.883, 4.135, 3.976, 3.749, 3.714, 3.653,
                    3.494, 3.569, 3.408, 3.331, 3.206, 3.071, 3.060, 3.043])
