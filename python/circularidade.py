...
registro vem das próprias decisões (xa_lidos, xb_lidos, xc_lidos, xd_lidos, xf_lidos,
dados_spin73), para não haver lista paralela que fique desatualizada.
...
for _sub in ("reconstrucao_A", "reconstrucao_B", "reconstrucao_C", "reconstrucao_D", "reconstrucao_F"):
    if os.path.join(_AQUI, _sub) not in sys.path:
        sys.path.insert(0, os.path.join(_AQUI, _sub))

import spin73 as s                                            # noqa: E402
from dados_cna import T as _T_CNA                             # noqa: E402
from xa_lidos import DECIDIDOS as _XA_DEC                     # noqa: E402
from xb_lidos import CORRECOES as _XB_CORR, DECIDIDO_POR as _XB_POR  # noqa: E402
from xc_lidos import CORRECOES as _XC_CORR, DECIDIDOS_M437, RECUPERADOS as _XC_REC  # noqa: E402
from xd_lidos import DECIDIDOS as _XD_DEC                     # noqa: E402
from xf_lidos import RECUPERADOS as _XF_REC                   # noqa: E402
