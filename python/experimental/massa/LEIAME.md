...
O SPIN-73 recebe o CG, o peso e as inércias como entrada. `spin73.massa` é uma **adição opcional** que os estima quando faltam. Esta pasta mede quanto a estimativa erra, contra projéteis com massa, CG e inércias medidos e publicados.

```
python experimental/massa/validar.py        # tabela completa; cópia em resultado.txt
```
