...
cartão do SPIN-73) e o de Hitchcock correspondente ("bala" ou "granada", BRL 620, p. 9).
    ...
    python experimental/massa/validar.py        -> tabela; também em resultado.txt

Fontes (geometria em calibres, dos esboços; massa e inércias das tabelas físicas):
  5,56 NATO    McCoy, BRL-MR-3476 (1985), Tabela 1 e Figs. 2-3   (benchmarks/nato556_mccoy1985.csv)
  7,62 match   McCoy, BRL-MR-3733 (1988), Tabela 1 e Figs. 3-5   (benchmarks/match762_mccoy1988.csv)
  .50 M33      McCoy, BRL-MR-3810 (1990), Tabela 1 e Fig. 4      (benchmarks/m33_mccoy1990.csv)
  cal .30      Hitchcock, BRL 620, pp. 16 e 18 impressas          (hitchcock/dados_cal030.py)
  ...
  T203 90 mm   Karpov et al., BRL MR 956 (1955), Figs. 1          (benchmarks/t203_karpov1955.csv)
  XM617        Brandon, BRL MR 1998 (1969), Fig. 3                (benchmarks/xm617_brandon1969.csv)
  M101         Karpov et al., BRL MR 1582 (1964), Tabela I        (benchmarks/m101_karpov1964.csv)
  M483A1       Whyte, BRL-CR-659 (1991), Tabela 1                 (benchmarks/m483a1_whyte1991.csv)
"""
import os
import sys
