...
Fecha a comparação que já existia para CNα (`../relatorio/`) e para Magnus (`comparar_magnus.py`):
...
if hasattr(sys.stdout, "reconfigure"):      # console do Windows é cp1252
    sys.stdout.reconfigure(encoding="utf-8", errors="replace")

AQUI = os.path.dirname(os.path.abspath(__file__))
sys.path[:0] = [AQUI, os.path.join(AQUI, ".."), os.path.join(AQUI, "..", "reconstrucao_F"),
                os.path.join(AQUI, "..", "reconstrucao_C"), os.path.join(AQUI, "..", "reconstrucao_B")]
